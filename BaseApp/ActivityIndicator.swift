...
public final class ActivityIndicator: UIView {
    ...
    public var rotationDuration: Double = 5
    ...
    private func updateSegments() {
        ...
        let angle = 2*CGFloat(Double.pi) / CGFloat(numSegments)
        ...
        let path = UIBezierPath(arcCenter: CGPoint(x: maxRadius, y: maxRadius), radius: radius, startAngle: -angle/2 - CGFloat(Double.pi)/2, endAngle: angle/2 - CGFloat(Double.pi)/2, clockwise: true)
    ...
    public func startAnimating() {
        ...
        rotate.byValue = CGFloat(Double.pi)*2
